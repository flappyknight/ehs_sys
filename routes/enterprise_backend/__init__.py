...
from .contractor_approval import router as contractor_approval_router
...
router.include_router(contractor_approval_router, prefix="/contractor-approval", tags=["企业供应商审批"])
