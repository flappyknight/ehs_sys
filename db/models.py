...
class User(SQLModel, table=True):
    ...
    enterprise_user: Optional["EnterpriseUser"] = Relationship(back_populates="user")
    contractor_user: Optional["ContractorUser"] = Relationship(back_populates="user")
...
class ContractorUser(SQLModel, table=True):
    ...
    user: Optional[User] = Relationship(back_populates="contractor_user")
...
class EnterpriseUser(SQLModel, table=True):
    ...
    user: Optional[User] = Relationship(back_populates="enterprise_user")
...
class Ticket(SQLModel, table=True):
    ...
    custodians: int = Field(default=None, foreign_key="enterprise_user.user_id", nullable=False)
